...
(async function testLogin() {
    ...
    try {
        ...
        const especificosButton = await driver.wait(until.elementLocated(By.id('radix-:r0:-trigger-especificas-jugadores')), 5000);
        
        // Hacer clic en el botón si se encuentra
        if (especificosButton) {
            await especificosButton.click(); // Hacer clic en el botón
            await driver.sleep(2000);
            console.log("Test logrado: El botón 'ESPECIFICOS-JUGADORES' fue encontrado y clickeado.");
            console.log('Prueba exitosa: PBI 15 realizada');
        } else {
            console.log("El botón 'ESPECIFICOS-JUGADORES'' no fue encontrado.");
        }
