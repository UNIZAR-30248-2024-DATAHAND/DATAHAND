...
(async function testLogin() {
    ...
    try {
        ...
        const sistemaDeJuegoButton = await driver.wait(until.elementLocated(By.id('radix-:r0:-trigger-sistema-de-juego')), 5000);
        
        // Hacer clic en el botón si se encuentra
        if (sistemaDeJuegoButton) {
            await sistemaDeJuegoButton.click(); // Hacer clic en el botón
            await driver.sleep(2000);
            console.log("Test logrado: El botón 'SISTEMA DE JUEGO' fue encontrado y clickeado.");
            console.log('Prueba exitosa: PBI 13 realizada');
        } else {
            console.log("El botón 'SISTEMA DE JUEGO' no fue encontrado.");
        }
