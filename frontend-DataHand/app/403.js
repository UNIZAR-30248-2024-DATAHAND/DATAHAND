    ...
    return (
        <div className="relative h-screen flex bg-orange-500 justify-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full p-8 text-center">
                <h1 className="text-6xl font-bold mb-4 text-white" style={{ fontFamily: 'var(--font-geist-sans)' }}>403</h1>
                ...
                <Link href="/">
                    <button className="bg-transparent text-white border-2 border-white p-3 rounded-full w-full max-w-xs font-semibold hover:bg-white hover:text-orange-600 transition duration-300 ease-in-out">
